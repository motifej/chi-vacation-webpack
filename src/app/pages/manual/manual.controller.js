					...
					<uib-accordion-group is-open="false">
						...
						<div class="manual">
							...
							<div class="scr-holder">
								<img class="img-responsive" src="../../../assets/images/scr-02.jpg" alt="image description">
							</div>
							<p>Создание запроса на отпуск или day-off для любого пользователя системы одинаково (<a ui-sref="manual">см. инструкцию для сотрудников</a>).</p>
							...
							<ul class="manual-list">
								...
								<li>
									...
									<div class="scr-holder text-center">
										<img class="img-responsive" src="../../../assets/images/scr-03.jpg" alt="image description">
										<span>Рис. 1</span>
									</div>
									<ul class="square">
								...
								<li>
									...
									<div class="scr-holder text-center">
										<img class="img-responsive" src="../../../assets/images/scr-04.jpg" alt="image description">
										<span>Рис. 2</span>
									</div>
									<ul class="square">
				...
				<uib-accordion>
					<uib-accordion-group is-open="isCollapsed"  id="user_manual">
						...
						<div class="manual">
							...
							<div class="scr-holder">
								<img class="img-responsive" src="../../../assets/images/scr-01.jpg" alt="image description">
							</div>
